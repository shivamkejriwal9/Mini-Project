...
public class NewJFrame extends javax.swing.JFrame {
    ...
    {
        String sql="select * from Customers where Phone_no=? and Password=?";
        try{
    ...
    private void initComponents() {
        ...
        jLabel4.setFont(new java.awt.Font("Baskerville", 2, 69)); // NOI18N
        jLabel4.setText("Fiacre Rental Service");
        ...
        jLabel5.setText("Re-inventing Cab Renting");
    ...
    private void jTextField1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusGained
        if(jTextField1.getText().trim().equalsIgnoreCase("1234567890"))
        {
            jTextField1.setText("");
